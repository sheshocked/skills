...
description: Formulate targeted brand value propositions using PAS and AIDA frameworks.
category: creative
tags: [branding, storytelling, copywriting]
---

# Brand Storytelling Copy

## When to Use
Use when implementing formulate targeted brand value propositions using pas and aida frameworks. inside production application development loops.
...
## Key Patterns
```
# General setup instructions for brand-storytelling-copy
