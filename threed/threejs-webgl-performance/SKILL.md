...
description: Reduce draw calls, compress textures sizes to KTX2, and implement instanced rendering in WebGL.
category: threed
tags: [threejs, webgl, performance-optimization]
---

# Threejs Webgl Performance

## When to Use
Use when implementing reduce draw calls, compress textures sizes to ktx2, and implement instanced rendering in webgl. inside production application development loops.
...
## Key Patterns
```
# General setup instructions for threejs-webgl-performance
