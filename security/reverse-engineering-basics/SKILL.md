...
description: Decompile APKs using jadx, inspect assembly in ghidra, and patch binary resources.
category: security
tags: [reverse-engineering, jadx, ghidra, security]
---

# Reverse Engineering Basics

## When to Use
Use when implementing decompile apks using jadx, inspect assembly in ghidra, and patch binary resources. inside production application development loops.
...
## Key Patterns
```
# General setup instructions for reverse-engineering-basics
