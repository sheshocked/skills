---
name: speech-stt-tts-pipelines
description: Configure local Whisper transcription loops and generate voice streams using Edge-TTS.
category: ai-tools
tags: [whisper, tts, speech-recognition]
---

# Speech Stt Tts Pipelines

## When to Use
Use when implementing configure local whisper transcription loops and generate voice streams using edge-tts. inside production application development loops.
...
## Key Patterns
```
# General setup instructions for speech-stt-tts-pipelines
