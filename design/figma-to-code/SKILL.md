---
name: figma-to-code
description: Export Figma frame parameters to clean CSS utility frameworks without code pollution.
category: design
tags: [figma, css, layout]
---

# Figma To Code

## When to Use
Use when implementing export figma frame parameters to clean css utility frameworks without code pollution. inside production application development loops.
...
## Key Patterns
```
# General setup instructions for figma-to-code
