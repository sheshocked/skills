...
description: Structure investor pitch decks slide layouts, presenting clear metrics and financials.
category: creative
...
## When to Use
Use when implementing structure investor pitch decks slide layouts, presenting clear metrics and financials. inside production application development loops.
...
## Key Patterns
```
# General setup instructions for pitch-deck-storytelling
