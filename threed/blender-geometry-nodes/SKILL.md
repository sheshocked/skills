...
description: Construct procedural meshes generators using geometry nodes and custom vector inputs.
category: threed
tags: [geometry-nodes, blender, 3d]
---

# Blender Geometry Nodes

## When to Use
Use when implementing construct procedural meshes generators using geometry nodes and custom vector inputs. inside production application development loops.
...
## Key Patterns
```
# General setup instructions for blender-geometry-nodes
